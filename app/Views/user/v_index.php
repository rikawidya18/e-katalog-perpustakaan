        ...
        ?>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>USR<?= sprintf("%04d", $value['id_user']) ?></td>
                    ...
                    <td class="text-center">
                        <?= $value['level'] == 'Admin' ? '<span class="badge badge-success">Admin</span>' : '<span class="badge badge-primary">Petugas</span>' ?>
                    </td>
                    <td class="text-center">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    Yakin Ingin Menghapus Data <b><?= $value['nama_user'] ?></b>... ?
                </div>
            </div>
