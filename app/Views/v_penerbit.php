                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-warning btn-flat btn-sm" data-toggle="modal"
                                data-target="#modal-edit<?= $value['id_penerbit'] ?>">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-flat btn-sm" data-toggle="modal"
                                data-target="#modal-delete<?= $value['id_penerbit'] ?>">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open(base_url('Penerbit/AddData')) ?>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nama Penerbit</label>
                    <input class="form-control" value="<?= $value['nama_penerbit'] ?>" name="nama_penerbit"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    Yakin Ingin Menghapus Data <b><?= $value['nama_penerbit'] ?></b>... ?
                </div>
            </div>
