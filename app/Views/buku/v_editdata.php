                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="kode_eksemplar"
                                    value="<?=  $buku['kode_eksemplar'] ?>" placeholder="Kode Eksemplar">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="eksemplar"
                                    value="<?=  $buku['eksemplar'] ?>" placeholder="Eksemplar">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="id_kategori" class="form-control">
                                        <option value="<?= $buku['id_kategori'] ?>"><?= $buku['nama_kategori'] ?>
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="id_penerbit" class="form-control">
                                        <option value="<?= $buku['id_penerbit'] ?>"><?= $buku['nama_penerbit'] ?>
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="id_pengarang" class="form-control">
                                        <option value="<?= $buku['id_pengarang'] ?>"><?= $buku['nama_pengarang'] ?>
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="id_rak" class="form-control">
                                        <option value="<?= $buku['id_rak'] ?>"><?= $buku['nama_rak'] ?>
                                        </option>
                                        <?php foreach ($rak as $key => $value) { ?>
                                        <option value="<?= $value['id_rak'] ?>"><?= $value['nama_rak'] ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                    <span class="input-group-append">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="tahun_terbit" class="form-control">
                                    <option value="<?= $buku['tahun_terbit'] ?>"><?= $buku['tahun_terbit'] ?>
                                    </option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="tempat_terbit" value="<?=  $buku['tempat_terbit'] ?>"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea rows="5" class="form-control"
                                    name="deskripsi"><?= $buku['deskripsi'] ?></textarea>
                            </div>
                        </div>
